      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <SectionHeading 
            ...
            subtitle="Pasioni për edukim dhe përsosmëri akademike që nga viti 1922"
          />
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-white mb-1">Prof. Arben Malaj</h4>
                  <p className="text-[#26a69a] mb-4">Drejtor i Shkollës</p>
                  <p className="text-[#c0c0c0] text-sm">Me mbi 25 vjet eksperiencë në fushën e arsimit dhe një pasion të pakrahasueshëm për edukimin e brezit të ri.</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-white mb-1">Dr. Elona Bejko</h4>
              ...
              >
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-white mb-1">Dr. Besnik Hoxha</h4>
                  <p className="text-[#26a69a] mb-4">Zv. Drejtor për Çështjet Administrative</p>
                  <p className="text-[#c0c0c0] text-sm">Ekspert në menaxhimin e burimeve shkollore dhe marrëdhëniet me komunitetin.</p>
                </div>
              </motion.div>
            </div>
          </div>
