            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Rruga Abdulla Keta, Nr. 15<br />10000 Prishtinë, Kosovë</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">(+383) 44 123 456</p>
                  <p className="text-neutral-600">(+383) 49 789 012</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">info@abdullaketa.edu</p>
                  <p className="text-neutral-600">kontakt@abdullaketa.edu</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">E Hënë - E Premte: 8:00 - 16:00</p>
                  <p className="text-neutral-600">E Shtunë: 9:00 - 12:00</p>
                </div>
              </div>
            </div>
          </div>
