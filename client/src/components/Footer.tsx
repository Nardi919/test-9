    ...
    <footer className="bg-primary pt-16 pb-6 relative z-10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/pisa" className="text-[#c0c0c0] hover:text-[#26a69a] transition-colors duration-300">PISA 2025</a></li>
              <li><a href="#" className="text-[#c0c0c0] hover:text-[#26a69a] transition-colors duration-300">Klubi Art & Zeje</a></li>
              <li><a href="#" className="text-[#c0c0c0] hover:text-[#26a69a] transition-colors duration-300">Klubi i Debatit</a></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-[#c0c0c0] text-sm mb-4 md:mb-0">© {new Date().getFullYear()} Gjimnazi "Abdulla Keta". Të gjitha të drejtat e rezervuara.</p>
